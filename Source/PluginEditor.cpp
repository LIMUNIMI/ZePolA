    ...
    : AudioProcessorEditor(&p), processor (p), valueTreeState (vts)
{
    ...
    reset_button->setBounds (1000, 520, 70, 30);
    ...
    frequency_response->setBounds (505, 35, 430, 270);
    ...
    ph_response_label->setBounds (660, 680, 110, 24);
    ...
    m1_slider->setBounds (25, 55, 135, 25);
    ...
    magnitudes_label->setBounds (46, 20, 90, 24);
    ...
    phases_label->setBounds (205, 20, 62, 24);
    ...
    zero_pole_label->setBounds (304, 20, 91, 24);
    ...
    e1_active->setBounds (405, 56, 35, 21);
    ...
    e2_active->setBounds (405, 101, 35, 21);
    ...
    e3_active->setBounds (405, 146, 35, 21);
    ...
    e4_active->setBounds (405, 191, 35, 21);
    ...
    e5_active->setBounds (405, 236, 35, 21);
    ...
    e6_active->setBounds (405, 281, 35, 21);
    ...
    e7_active->setBounds (405, 326, 35, 21);
    ...
    e8_active->setBounds (405, 371, 35, 21);
    ...
    linLog_switch->setBounds (886, 312, 52, 21);
    ...
    m2_slider->setBounds (25, 100, 135, 25);
    ...
    m3_slider->setBounds (25, 145, 135, 25);
    ...
    m4_slider->setBounds (25, 190, 135, 25);
    ...
    m5_slider->setBounds (25, 235, 135, 25);
    ...
    m6_slider->setBounds (25, 280, 135, 25);
    ...
    m7_slider->setBounds (25, 325, 135, 25);
    ...
    m8_slider->setBounds (25, 370, 135, 25);
    ...
    p2_slider->setBounds (170, 100, 135, 25);
    ...
    p3_slider->setBounds (170, 145, 135, 25);
    ...
    p4_slider->setBounds (170, 190, 135, 25);
    ...
    p5_slider->setBounds (170, 235, 135, 25);
    ...
    p6_slider->setBounds (170, 280, 135, 25);
    ...
    p7_slider->setBounds (170, 325, 135, 25);
    ...
    p8_slider->setBounds (170, 370, 135, 25);
...
void PluginEditor::paint (juce::Graphics& g)
{
    ...
    {
        float x = 15.0f, y = 15.0f, width = 470.0f, height = 720.0f;
    ...
    {
        float x = 485.0f, y = 15.0f, width = 470.0f, height = 720.0f;
        juce::Colour fillColour = juce::Colour (0x17b1b1b1);
        juce::Colour strokeColour = juce::Colour (0xff383838);
        //[UserPaintCustomArguments] Customize the painting arguments here..
        //[/UserPaintCustomArguments]
    ...
    {
        int x = 355, y = 708, width = 116, height = 30;
    ...
    {
        int x = 780, y = 708, width = 186, height = 30;
    ...
    {
        int x = 1025, y = 420, width = 90, height = 24;
    ...
    {
        int x = 1015, y = 20, width = 110, height = 24;
...
<JUCER_COMPONENT documentType="Component" className="PluginEditor" componentName=""
  ...
  <BACKGROUND backgroundColour="ffecf0f1">
    ...
    <ROUNDRECT pos="15 15 470 720" cornerSize="14.5" fill="solid: 17b1b1b1"
               hasStroke="1" stroke="1.5, mitered, butt" strokeColour="solid: ff383838"/>
    <ROUNDRECT pos="485 15 470 720" cornerSize="14.5" fill="solid: 17b1b1b1"
               hasStroke="1" stroke="1.5, mitered, butt" strokeColour="solid: ff383838"/>
    ...
    <TEXT pos="355 708 116 30" fill="solid: ff333333" hasStroke="0" text="FILTER SETUP"
          fontname="Gill Sans" fontsize="16.0" kerning="0.0" bold="0" italic="0"
          justification="36" typefaceStyle="SemiBold"/>
    <TEXT pos="780 708 186 30" fill="solid: ff333333" hasStroke="0" text="FILTER RESPONSE"
          fontname="Gill Sans" fontsize="16.0" kerning="0.0" bold="0" italic="0"
          justification="36" typefaceStyle="SemiBold"/>
    ...
    <TEXT pos="1025 420 90 24" fill="solid: ff333333" hasStroke="0" text="CONTROLS"
          fontname="Gill Sans" fontsize="13.0" kerning="0.0" bold="0" italic="0"
          justification="36" typefaceStyle="SemiBold"/>
    <TEXT pos="1015 20 110 24" fill="solid: ff333333" hasStroke="0" text="FILTER DESIGN"
          fontname="Gill Sans" fontsize="13.0" kerning="0.0" bold="0" italic="0"
          justification="36" typefaceStyle="SemiBold"/>
  ...
  <TEXTBUTTON name="Reset" id="2581837dc85daae9" memberName="reset_button"
              virtualName="" explicitFocusOrder="0" pos="1000 520 70 30" bgColOff="ff383838"
              buttonText="" connectedEdges="0" needsCallback="1" radioGroupId="0"/>
  <GENERICCOMPONENT name="frequencyResponse" id="161cb81e63dc8e46" memberName="frequency_response"
                    virtualName="" explicitFocusOrder="0" pos="505 35 430 270" class="GraphicResponse"
                    params="magnitudes"/>
  <LABEL name="Frequency response" id="4c8fffb65e845bfc" memberName="freq_response_label"
         virtualName="" explicitFocusOrder="0" pos="650 310 140 24" textCol="ff333333"
  ...
  <GENERICCOMPONENT name="phaseResponse" id="c9a48273dec25832" memberName="phase_response"
                    virtualName="" explicitFocusOrder="0" pos="525 415 390 260" class="GraphicResponse"
                    params="phases"/>
  <LABEL name="Phase response" id="6d08c4e421703ed5" memberName="ph_response_label"
         virtualName="" explicitFocusOrder="0" pos="660 680 110 24" textCol="ff333333"
  ...
  <SLIDER name="Element 1 magnitude" id="9107cda7959bc0ad" memberName="m1_slider"
          virtualName="" explicitFocusOrder="0" pos="25 55 135 25" thumbcol="ffffffff"
  ...
  <SLIDER name="Element 1 phase" id="b9f95ed5c32caef9" memberName="p1_slider"
          virtualName="" explicitFocusOrder="0" pos="170 55 135 25" thumbcol="ffffffff"
          textboxtext="ff333333" textboxbkgd="0" textboxhighlight="66686868"
          textboxoutline="0" min="0.0" max="10.0" int="0.0" style="LinearHorizontal"
          textBoxPos="TextBoxRight" textBoxEditable="1" textBoxWidth="50"
          textBoxHeight="20" skewFactor="1.0" needsCallback="0"/>
  ...
  <LABEL name="Phases" id="e0e34f187bbbdcdc" memberName="phases_label"
         virtualName="" explicitFocusOrder="0" pos="205 20 62 24" textCol="ff333333"
  ...
  <LABEL name="Zero / Pole" id="676532893526fbc7" memberName="zero_pole_label"
         virtualName="" explicitFocusOrder="0" pos="304 20 91 24" textCol="ff333333"
  ...
  <TOGGLEBUTTON name="Linear / Logarithmic" id="269b07022e58d862" memberName="linLog_switch"
                virtualName="" explicitFocusOrder="0" pos="886 312 52 21" buttonText=""
                connectedEdges="0" needsCallback="1" radioGroupId="0" state="0"/>
  <SLIDER name="Element 2 magnitude" id="e1a6d1b02cc8ab80" memberName="m2_slider"
          virtualName="" explicitFocusOrder="0" pos="25 100 135 25" thumbcol="ffffffff"
          textboxtext="ff333333" textboxbkgd="0" textboxhighlight="66686868"
          textboxoutline="0" min="0.0" max="10.0" int="0.0" style="LinearHorizontal"
          textBoxPos="TextBoxRight" textBoxEditable="1" textBoxWidth="50"
          textBoxHeight="20" skewFactor="1.0" needsCallback="0"/>
  <SLIDER name="Element 3 magnitude" id="b0094bd01977f340" memberName="m3_slider"
          virtualName="" explicitFocusOrder="0" pos="25 145 135 25" thumbcol="ffffffff"
          textboxtext="ff333333" textboxbkgd="0" textboxhighlight="66686868"
          textboxoutline="0" min="0.0" max="10.0" int="0.0" style="LinearHorizontal"
          textBoxPos="TextBoxRight" textBoxEditable="1" textBoxWidth="50"
          textBoxHeight="20" skewFactor="1.0" needsCallback="0"/>
  <SLIDER name="Element 4 magnitude" id="8f433acd768ec1d9" memberName="m4_slider"
          virtualName="" explicitFocusOrder="0" pos="25 190 135 25" thumbcol="ffffffff"
          textboxtext="ff333333" textboxbkgd="0" textboxhighlight="66686868"
          textboxoutline="0" min="0.0" max="10.0" int="0.0" style="LinearHorizontal"
          textBoxPos="TextBoxRight" textBoxEditable="1" textBoxWidth="50"
          textBoxHeight="20" skewFactor="1.0" needsCallback="0"/>
  <SLIDER name="Element 5 magnitude" id="fe0864ae3596b10d" memberName="m5_slider"
          virtualName="" explicitFocusOrder="0" pos="25 235 135 25" thumbcol="ffffffff"
          textboxtext="ff333333" textboxbkgd="0" textboxhighlight="66686868"
          textboxoutline="0" min="0.0" max="10.0" int="0.0" style="LinearHorizontal"
          textBoxPos="TextBoxRight" textBoxEditable="1" textBoxWidth="50"
          textBoxHeight="20" skewFactor="1.0" needsCallback="0"/>
  <SLIDER name="Element 6 magnitude" id="e6371565d3e4bb47" memberName="m6_slider"
          virtualName="" explicitFocusOrder="0" pos="25 280 135 25" thumbcol="ffffffff"
          textboxtext="ff333333" textboxbkgd="0" textboxhighlight="66686868"
          textboxoutline="0" min="0.0" max="10.0" int="0.0" style="LinearHorizontal"
          textBoxPos="TextBoxRight" textBoxEditable="1" textBoxWidth="50"
          textBoxHeight="20" skewFactor="1.0" needsCallback="0"/>
  <SLIDER name="Element 7 magnitude" id="3661ca4111317400" memberName="m7_slider"
          virtualName="" explicitFocusOrder="0" pos="25 325 135 25" thumbcol="ffffffff"
          textboxtext="ff333333" textboxbkgd="0" textboxhighlight="66686868"
          textboxoutline="0" min="0.0" max="10.0" int="0.0" style="LinearHorizontal"
          textBoxPos="TextBoxRight" textBoxEditable="1" textBoxWidth="50"
          textBoxHeight="20" skewFactor="1.0" needsCallback="0"/>
  <SLIDER name="Element 8 magnitude" id="8e83a0a6b9d1e264" memberName="m8_slider"
          virtualName="" explicitFocusOrder="0" pos="25 370 135 25" thumbcol="ffffffff"
          textboxtext="ff333333" textboxbkgd="0" textboxhighlight="66686868"
          textboxoutline="0" min="0.0" max="10.0" int="0.0" style="LinearHorizontal"
          textBoxPos="TextBoxRight" textBoxEditable="1" textBoxWidth="50"
          textBoxHeight="20" skewFactor="1.0" needsCallback="0"/>
  <SLIDER name="Element 2 phase" id="60007c00fdd0e234" memberName="p2_slider"
          virtualName="" explicitFocusOrder="0" pos="170 100 135 25" thumbcol="ffffffff"
          textboxtext="ff333333" textboxbkgd="0" textboxhighlight="66686868"
          textboxoutline="0" min="0.0" max="10.0" int="0.0" style="LinearHorizontal"
          textBoxPos="TextBoxRight" textBoxEditable="1" textBoxWidth="50"
          textBoxHeight="20" skewFactor="1.0" needsCallback="0"/>
  <SLIDER name="Element 3 phase" id="dad16f547c32eed" memberName="p3_slider"
          virtualName="" explicitFocusOrder="0" pos="170 145 135 25" thumbcol="ffffffff"
          textboxtext="ff333333" textboxbkgd="0" textboxhighlight="66686868"
          textboxoutline="0" min="0.0" max="10.0" int="0.0" style="LinearHorizontal"
          textBoxPos="TextBoxRight" textBoxEditable="1" textBoxWidth="50"
          textBoxHeight="20" skewFactor="1.0" needsCallback="0"/>
  <SLIDER name="Element 4 phase" id="2baa73d9d72e7d2a" memberName="p4_slider"
          virtualName="" explicitFocusOrder="0" pos="170 190 135 25" thumbcol="ffffffff"
          textboxtext="ff333333" textboxbkgd="0" textboxhighlight="66686868"
          textboxoutline="0" min="0.0" max="10.0" int="0.0" style="LinearHorizontal"
          textBoxPos="TextBoxRight" textBoxEditable="1" textBoxWidth="50"
          textBoxHeight="20" skewFactor="1.0" needsCallback="0"/>
  <SLIDER name="Element 5 phase" id="6ba360671cfe4646" memberName="p5_slider"
          virtualName="" explicitFocusOrder="0" pos="170 235 135 25" thumbcol="ffffffff"
          textboxtext="ff333333" textboxbkgd="0" textboxhighlight="66686868"
          textboxoutline="0" min="0.0" max="10.0" int="0.0" style="LinearHorizontal"
          textBoxPos="TextBoxRight" textBoxEditable="1" textBoxWidth="50"
          textBoxHeight="20" skewFactor="1.0" needsCallback="0"/>
  <SLIDER name="Element 6 phase" id="6fb200ac73072a45" memberName="p6_slider"
          virtualName="" explicitFocusOrder="0" pos="170 280 135 25" thumbcol="ffffffff"
          textboxtext="ff333333" textboxbkgd="0" textboxhighlight="66686868"
          textboxoutline="0" min="0.0" max="10.0" int="0.0" style="LinearHorizontal"
          textBoxPos="TextBoxRight" textBoxEditable="1" textBoxWidth="50"
          textBoxHeight="20" skewFactor="1.0" needsCallback="0"/>
  <SLIDER name="Element 7 phase" id="481e9546dc440bf4" memberName="p7_slider"
          virtualName="" explicitFocusOrder="0" pos="170 325 135 25" thumbcol="ffffffff"
          textboxtext="ff333333" textboxbkgd="0" textboxhighlight="66686868"
          textboxoutline="0" min="0.0" max="10.0" int="0.0" style="LinearHorizontal"
          textBoxPos="TextBoxRight" textBoxEditable="1" textBoxWidth="50"
          textBoxHeight="20" skewFactor="1.0" needsCallback="0"/>
  <SLIDER name="Element 8 phase" id="d587f0ce08864b4e" memberName="p8_slider"
          virtualName="" explicitFocusOrder="0" pos="170 370 135 25" thumbcol="ffffffff"
          textboxtext="ff333333" textboxbkgd="0" textboxhighlight="66686868"
          textboxoutline="0" min="0.0" max="10.0" int="0.0" style="LinearHorizontal"
          textBoxPos="TextBoxRight" textBoxEditable="1" textBoxWidth="50"
          textBoxHeight="20" skewFactor="1.0" needsCallback="0"/>
