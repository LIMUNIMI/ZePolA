...
: processor(p), valueTreeState(vts)
{
    ...
    anticlockwise_arrow_svg = juce::Drawable::createFromImageData (BinaryData::anticlockwise_arrow_svg, BinaryData::anticlockwise_arrow_svgSize);
    clockwise_arrow_svg = juce::Drawable::createFromImageData (BinaryData::clockwise_arrow_svg, BinaryData::clockwise_arrow_svgSize);
    load_icon_svg = juce::Drawable::createFromImageData (BinaryData::load_icon_svg, BinaryData::load_icon_svgSize);
    save_icon_svg = juce::Drawable::createFromImageData (BinaryData::save_icon_svg, BinaryData::save_icon_svgSize);
